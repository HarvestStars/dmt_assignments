...
plt.legend()
plt.grid()
plt.title("Decision Tree Regression Predictions (train set)")
plt.xlabel("Test set")
plt.ylabel("Target mood")
plt.show()

plt.figure(figsize=(10, 5))
plt.plot(y_test, label="True Values", color="red", linestyle="--")
plt.plot(test_predictions, label="Predictions (max_depth=3)", color="blue")
plt.plot(test_predictions2, label="Predictions (max_depth=5)", color="green")
plt.legend()
plt.grid()
plt.title("Decision Tree Regression Predictions (test set)")
plt.xlabel("Test set")
plt.ylabel("Target mood")
plt.show()
